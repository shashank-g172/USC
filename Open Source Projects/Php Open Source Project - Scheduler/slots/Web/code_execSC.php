...
if($result1)
{
	...
	//	echo "User id ", $uid;
		...
		if ($details) {
			$query = "INSERT INTO scprofile (user_id, SCuser_name,CenterName,SCaddress,city,state,zip,SCphone,email,staff_size,details,poc_name,poc_contact, poc_designation, image )VALUES('$uid', '$uname', '$cname', '$addr', '$city', '$state', '$zip', '$phone', '$email', '$size', '$details','$Contact_Person','$Contact_Num','$Designation','$renamed_name')";
		}
		else {
