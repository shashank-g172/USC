 ...
 */
$conf['settings']['app.title'] = 'Surgery Assist';			// application title
$conf['settings']['default.timezone'] = 'America/Los Angeles';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'true';         	// if users can register themselves
$conf['settings']['admin.email'] = 'userbooked@gmail.com';         // email address of admin user
...
$conf['settings']['script.url'] = 'http://localhost/slots/Web/';   
	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in
...
$conf['settings']['registration.auto.subscribe.email'] = 'true';			// requires enable.email = true
...
// database user with permission to the booked database
...
$conf['settings']['phpmailer']['smtp.username'] = 'userbooked@gmail.com';
$conf['settings']['phpmailer']['smtp.password'] = 'zaq1!xsw2@';
$conf['settings']['phpmailer']['sendmail.path'] = 'C:\wamp\bin\sendmail\sendmail.exe -t -i';
$conf['settings']['phpmailer']['smtp.debug'] = 1;
/**
 ...
 */
$conf['settings']['install.password'] = 'pass123';
/**
 * Pages
 */
 ...
 * Email
 */
$conf['settings']['email']['default.from.address'] = 'userbooked@gmail.com';
/**
 * Reports
 */
