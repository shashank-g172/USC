...
class SchedulePage extends ActionPage implements ISchedulePage
{
	...
	public function ProcessPageLoadForSc($user)
	{
		...
		$uid = $_SESSION['uid'];
		$username = $_SESSION['centername'];
		$complete_address = $_SESSION['address'];
		$phone = $_SESSION['phone'];
		$email = $_SESSION['email']; 
		$this->Set('uid', $uid);
		$this->Set('username', $username);
		$this->Set('address', $complete_address);
		...
		{
			$this->Display('Schedule/schedule-sc.tpl');
		}
