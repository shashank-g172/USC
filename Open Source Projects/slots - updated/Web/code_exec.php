...
$user = $registration->Register($uname, $email, $fname, $lname, $password, "America/Los_Angeles", "en_us", 1, array(), array());
...
if($result1)
{
	while($row = mysql_fetch_array($result1))
	{
		...
		if ($desc) {
			...
			$query = "INSERT INTO docprofile (user_id, duser_name, doctor_fname,doctor_lname,phone_no,email,gender,license_no,expirydate,spec_data,personal_desc, certificate1)VALUES('$uid', '$uname', '$fname', '$lname', '$PNo', '$email', '$gender', '$LNum',  $Edate_format, '$spec', '$desc','$image')";
			//echo $query;
		}
		else {
			$query = "INSERT INTO docprofile (user_id, duser_name, doctor_fname,doctor_lname,phone_no,email,gender,license_no,expirydate,spec_data,certificate1)VALUES('$uid', '$uname', '$fname', '$lname', '$PNo', '$email', '$gender', '$LNum',  $Edate_format, '$spec','$image')";
			//echo $query;
		}
