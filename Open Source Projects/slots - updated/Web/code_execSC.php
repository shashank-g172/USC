...
$user = $registration->Register($uname, $email, $cname, "", $password, "America/Los_Angeles", "en_us", 1, array(), array());
...
if($result1)
{
	...
	//	echo "User id ", $uid;
		...
		if ($details) {
			$query = "INSERT INTO scprofile (user_id, SCuser_name,CenterName,SCaddress,city,state,zip,SCphone,email,staff_size,details )VALUES('$uid', '$uname', '$cname', '$addr', '$city', '$state', '$zip', '$phone', '$email', '$size', '$details')";
		}
		else {
