...
<?php 
		...
		if ($result1) {
			while ($row = mysql_fetch_array($result1)) {
				...
				$size = $row['staff_size'];
				$det = $row['details'];
        $Cperson=$row['poc_name'];
        $CPhone=$row['poc_contact'];
        $Cdesig=$row['poc_designation'];
        $Description_Image=$row['image'];
        $insurances=$row['insurance'];
			}
		}
		 
echo <<<EOT
<div id="carbonForm">
<form enctype="multipart/form-data" name="reg"  action="code_execSC_update.php" onsubmit="return validateForm()" method="post">
* required field
 ...
 <div>
    ...
    <div class="formRow">
            ...
            <div class="field">
                <input type="text" name="cperson" value="$Cperson"/>
            </div>
    </div>
  ...
  <div class="formRow">
            ...
            <div class="field">
                <input type="text" name="designation" value="$Cdesig"/>
            </div>
    </div>  
...
<div class="formRow">
            ...
            <div class="field">
                 <input type="text" name="insurances" value="$insurances" readonly/>
            </div>
    </div> 
    <div class="formRow">
            <div class="label">
            ...
            <div class="field">
                <input type='tel' pattern='\d{10}'  name="ContactPNo" value="$CPhone"> 
            </div>
    </div>
...
<div class="zoom_img_2">
  <img  src="certificates/$Description_Image" onerror="this.src=''">
 </div>

<div class="del1">
<a href="delete.php?action=delete&filename=certificates/$Description_Image" style="text-decoration:none;">Delete</a>
</div>

</div>	
	<br/>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	<input type="submit" name="Update" value="Update" style="margin-left: 18%;"/>
	</form>
