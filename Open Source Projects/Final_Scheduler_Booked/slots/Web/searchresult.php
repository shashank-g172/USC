...
<!--  <body style="margin:0px; padding:0px;" onload="initialize()"> -->
  		<body style="margin:0px; padding:0px;" onload="initialize('Los Angeles, CA')">
<?php
...
$today = date('Y-m-d');
?>
<!-- <div id="results" style="overflow: scroll; 	float: left;	height:500px;	width:500px;	margin-top:0px;	margin-bottom:100px;	margin-left:10px;"> -->
...
if ($length === 1)
{
	echo '<div style="margin-left:45px; font-size: 15px; text-align:center;"> <h2>No relevant search results.</br> Please retry your search</h2> </div>' ;	
}
else{
echo '<div id="results" style="overflow: scroll; 	float: left;	height:500px;	width:500px;	margin-top:0px;	margin-bottom:100px;	margin-left:10px;">';
for ($i = 1; $i < $length; $i++) {
