...
* required field   
  ...
  <div class="formRow">
            ...
            <div class="field">
                <input type="date" name="EDate" min=$today value= "$Edate"/>
            </div>
    </div>  
...
<div class="del1">
<a href="delete.php?action=delete&filename=certificates/$image2" style="text-decoration:none;">Delete</a>
</div>

<div class="del2">
<a href="delete.php?action=delete&filename=certificates/$image3" style="text-decoration:none;">Delete</a>
</div>
