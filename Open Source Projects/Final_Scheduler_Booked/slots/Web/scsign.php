...
<div>
  ...
  <div class="formRow">
	...
	<div class="formRow">
            ...
            <div class="field">
                <input type="text" name="cname" placeholder="Surgery Center Name"/>
            </div>
    </div>
  ...
  <div class="formRow">
            ...
            <div class="field">
                <input type="text" name="addr" placeholder="Street Address"/>
            </div>
    </div>
  ...
  <option value="WV">West Virginia</option> <option value="WI">Wisconsin</option> <option value="WY">Wyoming</option>
    ...
    <div class="formRow">
            ...
            <div class="field">
                <input type="email" name="email" placeholder="trojan@usc.edu"/>
            </div>
    </div>
  ...
  <div class="formRow">
	...
	<div class="formRow">
            ...
            <div class="field">
                <input type="text" name="size" placeholder="Num of Staffs"/>
            </div>
    </div>
    ...
    <div class="formRow">
            ...
            <div class="field">
                <input type="text" name="cperson" placeholder="Point of Contact"/>
            </div>
    </div>
    ...
    <div class="formRow">
            ...
            <div class="field">
                <input type="text" name="designation" placeholder="POC Designation"/>
            </div>
    </div>  
    ...
    <div class="formRow">
            ...
            <div class="field">
                <input type='tel' pattern='\d{10}'  name="ContactPNo" placeholder="Please enter 10 digits" /> 
            </div>
    </div>
  ...
  <div class="formRow" >
            ...
            <div class="field">
                <textarea name="details" rows="6" cols="30" maxlength="99" style="background: #E0EEE0; placeholder=""Description"></textarea>  <br/><br/>
            </div>
    </div>
  ...
  <div class="formRow">
            <div class="label">
                <label for="InsuranceComp">Insurance*:</label>
            </div>
      ...
      <div class="field">
                   ...
                   <p id="addnew">
                   <a href="javascript:add_feed()" style="text-decoration: none">Add New </a>
                  </p>
	...
	<div >
	<img  src="img/footer2.jpg" width='100%' height="2px" />
	</div>

	<br/>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
	<input type="submit" name="Register" value="Register" style="align:centre" />
	</form>
