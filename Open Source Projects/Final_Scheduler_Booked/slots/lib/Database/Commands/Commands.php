...
class AssignResourcePermissionsCommand extends SqlCommand
{
	public function __construct($resourceId, $userId)
	{
		parent::__construct(Queries::ASSIGN_RESOURCE_PERMISSIONS);
		$this->AddParameter(new Parameter(ParameterNames::RESOURCE_ID, $resourceId));
		$this->AddParameter(new Parameter(ParameterNames::USER_ID, $userId));
	}
}
...
class GetScheduleAdminsCommand extends SqlCommand
{
	public function __construct($resourceId)
	{
		parent::__construct(Queries::GET_SCHEDULE_ADMIN);
		$this->AddParameter(new Parameter(ParameterNames::RESOURCE_ID, $resourceId));
	}
}

class GetReservationUsersCommand extends SqlCommand
{
	public function __construct($userName)
	{
		parent::__construct(Queries::GET_RESERVATION_USER);
		$this->AddParameter(new Parameter(ParameterNames::USERNAME, $userName));
	}
}

class GetIsDoctorCommand extends SqlCommand
{
	public function __construct($userid)
	{
		parent::__construct(Queries::IS_DOCTOR);
		$this->AddParameter(new Parameter(ParameterNames::USER_ID, $userid));
	}
}

class GetIsSCCommand extends SqlCommand
{
	public function __construct($userid)
	{
		parent::__construct(Queries::IS_SC);
		$this->AddParameter(new Parameter(ParameterNames::USER_ID, $userid));
	}
}
...
class GetGroupIdCommand extends SqlCommand
{
	public function __construct($userId)
	{
		parent::__construct(Queries::GET_GROUP_ID);
		$this->AddParameter(new Parameter(ParameterNames::USER_ID, $userId));
	}
}
...
class GetUserWithPermissionsCommand extends SqlCommand
{
	public function __construct($userId)
	{
		parent::__construct(Queries::GET_USER_RESOURCE_WITH_PERMISSIONS);
