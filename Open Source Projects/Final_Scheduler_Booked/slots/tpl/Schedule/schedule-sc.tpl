...
{block name="header"}
	{include file='globalheader.tpl' cssFiles='css/jquery.qtip.min.css,scripts/css/jqtree.css,css/schedule.css,css/styles.css'}
{/block}
	...
	<div>
		...
		<div style="text-align: left; width:100px; float:left; font-size:12pt">
			<div class="zoom_img_4">
			  <img src="certificates/{$image}"/>
			 </div> 
			<h5>Address: <br/> </h5>
			<p>{$address}</p> <br/>
			<h5>Phone: <br/> </h5>
			<p>{$phone}</p> <br/>
			<a style="font-size:12pt">{$email}</a> <br/> <br/>
