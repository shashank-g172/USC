...
public class Sentence {
	...
	static LinkedList<String> literals = new LinkedList<String>();
...
int flag=0;
		...
		StringBuffer newStringBuffer = new StringBuffer(buffer.toString().replaceAll("null", " "));  
		
		writer.write(newStringBuffer.toString());
		writer.close();
		}
		if(flag==2) {
			File outputFile =  new File(args[3]);
			...
			} System.out.println("If you are seeing this, then this part was not done");
		}
		if(flag==3) {
